...
export default async function ConsulairePage() {
  ...
  return (
    <main className="min-h-screen p-6 max-w-2xl mx-auto">
      ...
      <h1 className="font-serif text-2xl font-bold mt-2 mb-4">Service consulaire</h1>
      <div className="bg-white rounded-xl shadow-sm ring-1 ring-black/5 p-8 text-center">
        <p className="text-neutral-500">
          Ce module est en cours de construction — passeports, visas et cartes consulaires pour les
          ressortissants ivoiriens de la circonscription.
        </p>
      </div>
    </main>
  );
